...
// Keep CAST for binary literals even when the field types compare equal,
// otherwise aggregation elimination can expose the raw literal and change
// truthiness in HAVING.
