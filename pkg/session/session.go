...
func (s *session) rebuildFromPrepareCache(
	...
	newStmt := &plannercore.PlanCacheStmt{
		...
		PreprocessSQLMode:             s.sessionVars.SQLMode,
		PreprocessNoopFuncsMode:       s.sessionVars.NoopFuncsMode,
		PreprocessSharedLockPromotion: s.sessionVars.SharedLockPromotion,
