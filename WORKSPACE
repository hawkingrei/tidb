...
http_archive(
    ...
    urls = [
        "http://bazel-cache.pingcap.net:8080/bazel-contrib/rules_go/releases/download/v0.60.0/rules_go-v0.60.0.zip",
        "http://ats.apps.svc/bazel-contrib/rules_go/releases/download/v0.60.0/rules_go-v0.60.0.zip",
